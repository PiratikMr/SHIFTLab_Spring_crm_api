...
public class AnalyticsService {
    ...
    // Получение самого продуктивного продавца в рамках (DAY, MONTH, QUARTER, YEAR)
    public SellerDTO getMostProductiveSeller(String periodType) {
        ...
        switch (periodType.toUpperCase()) {
            ...
            case "QUARTER":
                ...
                startDate = now.withMonth(startMonth).withDayOfMonth(1);
                break;
            case "YEAR":
    ...
    // Получение списка продавцов, у которых сумма транзакций за выбранный период меньше переданного параметра суммы
    public List<SellerShortDTO> getSellersWithTotalAmountLessThan(LocalDateTime startDate, LocalDateTime endDate, BigDecimal maxTotalAmount) {
        ...
        List<Seller> sellers = sellerRepository.findSellersWithTotalAmountBelow(maxTotalAmount, startDate, endDate);
