...
public class SellerControllerTest {
    ...
    void createSeller_ShouldReturnCreatedSeller_Success() throws Exception {
        ...
        when(sellerService.createSeller(any(Seller.class))).thenReturn(createdDto);
    ...
    void updateSeller_ShouldReturnUpdatedSeller_Success() throws Exception {
        ...
        String updatedContact = "new@contact.com";

        Seller updateDetails = new Seller();
        updateDetails.setName(updatedName);
        updateDetails.setContactInfo(updatedContact);

        SellerDTO updatedDto = new SellerDTO();
        updatedDto.setId(1L);
        updatedDto.setName(updatedName);
        updatedDto.setContactInfo(updatedContact);
        ...
        when(sellerService.updateSeller(eq(1L), any(Seller.class))).thenReturn(updatedDto);
        ...
        verify(sellerService, times(1)).updateSeller(eq(1L), any(Seller.class));
    }
